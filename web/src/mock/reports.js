...
const CATEGORY_DATA = [
    { category: 'privacy_policy', label: 'Politica de Privacidade', codes: ['C01', 'C02', 'C03', 'C04', 'C05', 'C06', 'C07', 'C08'], maxScore: 25 },
    { category: 'cookies', label: 'Cookies', codes: ['C09', 'C10', 'C11', 'C12', 'C13', 'C14'], maxScore: 25 },
    { category: 'forms', label: 'Formularios', codes: ['C15', 'C16', 'C17', 'C18'], maxScore: 15 },
    ...
    { category: 'security', label: 'Seguranca Basica', codes: ['C28', 'C29', 'C30', 'C31'], maxScore: 10 },
