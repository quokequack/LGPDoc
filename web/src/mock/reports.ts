...
function makeFindings(): FindingItem[] {
  const findings: FindingItem[] = [
    ...
    { id: 'f-01', criterionCode: 'C01', criterionName: 'Existência de política de privacidade', status: 'found', score: 3.12, maxScore: 3.12, evidence: 'Política encontrada em /politica-de-privacidade com data de atualização e link no rodapé.', explanation: 'A LGPD exige transparência no tratamento de dados. A ausência de política impede que o titular saiba como seus dados são usados.', lgpdReference: 'Art. 6, VI, LGPD (Transparência)', recommendations: [] },
    { id: 'f-02', criterionCode: 'C02', criterionName: 'Menção aos dados coletados', status: 'found', score: 3.12, maxScore: 3.12, evidence: 'Política lista nome, e-mail, telefone, CPF, data de nascimento, convênio e histórico de agendamentos.', explanation: 'O princípio da transparência exige que o titular saiba quais dados são coletados.', lgpdReference: 'Art. 6, VI, LGPD', recommendations: [] },
    { id: 'f-03', criterionCode: 'C03', criterionName: 'Menção à finalidade', status: 'found', score: 3.12, maxScore: 3.12, evidence: 'Finalidades descritas para agendamento, lembrete de consulta, faturamento e comunicação de campanhas preventivas.', explanation: 'O princípio da finalidade determina que os dados sejam coletados para propósitos legítimos e específicos.', lgpdReference: 'Art. 6, I, LGPD (Finalidade)', recommendations: [] },
    ...
    { id: 'f-05', criterionCode: 'C05', criterionName: 'Menção ao compartilhamento', status: 'partial', score: 1.56, maxScore: 3.12, evidence: 'Cita "laboratórios, operadoras e parceiros de tecnologia" sem listar categorias de destinatários por finalidade.', explanation: 'O titular tem direito de saber com quem seus dados são compartilhados.', lgpdReference: 'Art. 9, LGPD', recommendations: [{ id: 'r-05', title: 'Detalhar compartilhamento', priority: 'high', description: 'A política usa categorias amplas para terceiros envolvidos em consultas, exames e infraestrutura.', howToImprove: 'Listar categorias de terceiros e finalidades do compartilhamento, separando assistência, faturamento, suporte técnico e marketing.' }] },
    { id: 'f-06', criterionCode: 'C06', criterionName: 'Menção a bases legais', status: 'partial', score: 1.56, maxScore: 3.12, evidence: 'Menciona consentimento para newsletter, mas não associa execução de contrato, tutela da saúde e obrigação legal aos demais fluxos.', explanation: 'Toda operação de tratamento deve ter uma base legal válida.', lgpdReference: 'Art. 7, LGPD', recommendations: [{ id: 'r-06', title: 'Mapear bases legais por finalidade', priority: 'medium', description: 'Bases legais aparecem de forma incompleta para agendamento, prontuário e cobrança.', howToImprove: 'Criar tabela com finalidade, dados utilizados, base legal, prazo de retenção e destinatários.' }] },
    { id: 'f-07', criterionCode: 'C07', criterionName: 'Identificação do controlador', status: 'partial', score: 1.56, maxScore: 3.12, evidence: 'Rodapé exibe nome fantasia da clínica, mas a política não informa razão social completa nem CNPJ.', explanation: 'O titular precisa saber quem é o responsável pelo tratamento de seus dados.', lgpdReference: 'Art. 6, VII, LGPD', recommendations: [{ id: 'r-07', title: 'Identificar controlador', priority: 'high', description: 'A política não informa a pessoa jurídica responsável pelo portal.', howToImprove: 'Incluir razão social, CNPJ, endereço e canal formal do controlador.' }] },
    { id: 'f-08', criterionCode: 'C08', criterionName: 'Canal de contato / DPO', status: 'partial', score: 1.56, maxScore: 3.12, evidence: 'E-mail atendimento@clinica-horizonte.test aparece no rodapé, mas não há canal dedicado à privacidade.', explanation: 'A LGPD garante ao titular o direito de obter informações.', lgpdReference: 'Art. 9, LGPD', recommendations: [{ id: 'r-08', title: 'Criar canal dedicado', priority: 'medium', description: 'Canal atual mistura atendimento clínico, agenda e privacidade.', howToImprove: 'Criar privacidade@clinica-horizonte.test e indicar encarregado ou área responsável.' }] },
    ...
    { id: 'f-14', criterionCode: 'C14', criterionName: 'Cookies não necessários antes de consentimento', status: 'absent', score: 0, maxScore: 4.15, evidence: '_ga, _fbp e hzt_adsid carregam antes de qualquer escolha no banner.', explanation: 'Carregar cookies não essenciais antes do consentimento viola o princípio do consentimento prévio.', lgpdReference: 'Art. 7, LGPD', recommendations: [{ id: 'r-14', title: 'Bloquear cookies antes do consentimento', priority: 'high', description: 'Cookies de analytics e marketing carregam antes do aceite.', howToImprove: 'Configurar GTM e scripts para carregar apenas após consentimento.' }] },

    // FORMS C15-C18
    { id: 'f-15', criterionCode: 'C15', criterionName: 'Identificação de campos de dados pessoais', status: 'found', score: 3.75, maxScore: 3.75, evidence: 'Formulário de agendamento coleta nome, CPF, telefone, e-mail, convênio e especialidade desejada.', explanation: 'Identificação de dados pessoais coletados.', lgpdReference: 'Art. 5, I, LGPD', recommendations: [] },
    { id: 'f-16', criterionCode: 'C16', criterionName: 'Minimização de dados', status: 'partial', score: 1.88, maxScore: 3.75, evidence: 'Formulário de newsletter solicita data de nascimento e telefone, embora a finalidade declarada seja envio de conteúdo preventivo.', explanation: 'O princípio da necessidade limita a coleta ao mínimo necessário.', lgpdReference: 'Art. 6, III, LGPD', recommendations: [{ id: 'r-16', title: 'Reduzir campos por finalidade', priority: 'medium', description: 'Campos extras aparecem em fluxos de baixa necessidade.', howToImprove: 'Manter apenas e-mail e consentimento na newsletter; solicitar dados adicionais somente quando indispensáveis ao atendimento.' }] },
    { id: 'f-17', criterionCode: 'C17', criterionName: 'Detecção de dados sensíveis', status: 'partial', score: 1.88, maxScore: 3.75, evidence: 'Campo "descreva seu sintoma" aparece no pré-agendamento sem aviso destacado sobre dado sensível.', explanation: 'Dados sensíveis merecem proteção especial.', lgpdReference: 'Art. 5, II e Art. 11, LGPD', recommendations: [{ id: 'r-17', title: 'Tratar dados de saúde como sensíveis', priority: 'high', description: 'O formulário pode receber informações sobre saúde antes de contextualizar o titular.', howToImprove: 'Adicionar aviso específico, restringir campo livre e explicar base legal e finalidade do tratamento.' }] },
    { id: 'f-18', criterionCode: 'C18', criterionName: 'Aviso de privacidade no formulário', status: 'absent', score: 0, maxScore: 3.75, evidence: 'Botões "Solicitar consulta" e "Entrar na newsletter" não exibem aviso curto de privacidade.', explanation: 'O titular deve ser informado sobre o tratamento no momento da coleta.', lgpdReference: 'Art. 9, LGPD', recommendations: [{ id: 'r-18', title: 'Adicionar aviso de privacidade contextual', priority: 'medium', description: 'Formulários sem texto informativo sobre uso dos dados.', howToImprove: 'Adicionar texto curto junto aos botões, com link para a política e finalidade específica de cada formulário.' }] },
    ...
    { id: 'f-31', criterionCode: 'C31', criterionName: 'Scripts externos', status: 'absent', score: 0, maxScore: 2.5, evidence: 'Google Analytics, Facebook Pixel, Hotjar e widget de chat carregados no primeiro acesso.', explanation: 'Scripts de terceiros podem coletar dados dos visitantes.', lgpdReference: 'Art. 46, LGPD', recommendations: [{ id: 'r-31', title: 'Revisar scripts de terceiros', priority: 'low', description: '4 scripts externos detectados em páginas de agendamento e conteúdo.', howToImprove: 'Revisar necessidade de cada script, documentar finalidade e condicionar ferramentas não essenciais ao consentimento.' }] },

    // LANGUAGE C32-C33
    { id: 'f-32', criterionCode: 'C32', criterionName: 'Termos excessivamente genéricos', status: 'partial', score: 1.25, maxScore: 2.5, evidence: 'Frases como "melhorar sua jornada de saúde" e "pelo período necessário" aparecem sem critério objetivo.', explanation: 'Frases vagas violam o princípio de transparência.', lgpdReference: 'Art. 6, VI, LGPD', recommendations: [{ id: 'r-32', title: 'Substituir termos genéricos', priority: 'medium', description: '2 frases vagas detectadas em política e banner.', howToImprove: 'Substituir por descrições específicas de dados, finalidades, prazos e procedimentos.' }] },
...
function makeCookies(): CookieItem[] {
  return [
    { id: 'ck-1', name: 'hzt_session', domain: 'demo.lgpdoc.test', type: 'necessary', origin: 'first_party', duration: 'session', loadedBeforeConsent: false, description: 'Cookie de sessão necessário para área de pacientes.' },
    { id: 'ck-2', name: 'csrf_token', domain: 'demo.lgpdoc.test', type: 'necessary', origin: 'first_party', duration: 'session', loadedBeforeConsent: false, description: 'Token de segurança CSRF.' },
    ...
    { id: 'ck-4', name: '_hjSession', domain: '.hotjar.com', type: 'analytics', origin: 'third_party', duration: 'persistent', loadedBeforeConsent: true, description: 'Hotjar - mapas de calor e gravação de sessão.' },
    ...
    { id: 'ck-7', name: 'pref_specialty', domain: 'demo.lgpdoc.test', type: 'functional', origin: 'first_party', duration: 'persistent', loadedBeforeConsent: false, description: 'Preferência de especialidade selecionada pelo visitante.' },
  ];
}
...
const CATEGORY_DATA = [
  { category: 'privacy_policy' as const, label: 'Política de Privacidade', codes: ['C01','C02','C03','C04','C05','C06','C07','C08'], maxScore: 25 },
  { category: 'cookies' as const, label: 'Cookies', codes: ['C09','C10','C11','C12','C13','C14'], maxScore: 25 },
  { category: 'forms' as const, label: 'Formulários', codes: ['C15','C16','C17','C18'], maxScore: 15 },
  ...
  { category: 'security' as const, label: 'Segurança Básica', codes: ['C28','C29','C30','C31'], maxScore: 10 },
...
export function getMockReport(scanId: string, url: string): ReportResponse {
  ...
  return {
    ...
    cookies: makeCookies(),
    forms: makeForms(),
    legalDisclaimer: 'Esta análise usa dados simulados de um site fictício para demonstração do LGPDoc. O resultado tem caráter exclusivamente educativo e não constitui parecer jurídico, certificação de conformidade ou avaliação real da LGPD.',
  };
}
